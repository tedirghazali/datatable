          ...
          <tr>
            <th v-for="(col, ind) in columns" :key="'col-'+ind">
              <div class="check" v-if="col.type === 'checkbox'">
                <input type="checkbox" ref="checkedAll" class="checkInput" @click="checks = (checks.checked === true) ? flatByProp(col.prop) : []">
              </div>
              <template v-else>
                <div :class="theme.tableSort">
                  <span>{{ col.text }}</span>
                  <span v-if="getSort.col === col.prop && getSort.by === 'asc'" @click="getSort.col = col.prop; getSort.by = 'desc'; emit('sort', sort);">
                  ...
                  <span v-else-if="getSort.col === col.prop && getSort.by === 'desc'" @click="getSort.col = col.prop; getSort.by = 'asc'; emit('sort', sort);">
                  ...
                  <span v-else @click="getSort.col = col.prop; getSort.by = 'asc'; emit('sort', sort);">
